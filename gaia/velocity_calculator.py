...
Originally from astrolibpy
Author: Sergey Koposov

Calculates the velocities using function below

'''

import numpy

def calculate_space_velocity(distance=None, lsr=None, ra=None, dec=None, pmra=None, pmdec=None, vrad=None, plx=None):
    """
    NAME:
    calculate_space_velocity
    PURPOSE:
